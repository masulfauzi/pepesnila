                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->statusAjuan->status_ajuan }}</td>
									
									
                                    <td>
                                        <a href="{{ route('ajuan.upload.index', ["ajuan" => $item->id]) }}" class="btn btn-sm icon icon-left btn-outline-secondary">Upload Berkas</a>
										{{-- {!! button('ajuan.show','', $item->id) !!} --}}
										{{-- {!! button('ajuan.edit', $title, $item->id) !!} --}}
                                        {!! button('ajuan.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
